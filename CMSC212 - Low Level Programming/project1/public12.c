/*
 * CMSC 212, Spring 2120, Project #1
...
int main() {
  ...
  init_word(&mem[1], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 175);
  init_word(&mem[2], INSTR, MUL,  R3,  R4,  R5,  EMP, EMP, EMP);
  init_word(&mem[3], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 751);
  init_word(&mem[4], INSTR, MOD,  R4,  R3,  R2,  EMP, EMP, EMP);
  init_word(&mem[5], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 571);
  init_word(&mem[6], INSTR, NEG,  R2,  R1,  EMP, EMP, EMP, EMP);
  init_word(&mem[7], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 715);
  init_word(&mem[8], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 517);
  init_word(&mem[9], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 157);
  ...
  init_word(&mem[108], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, 999);
  init_word(&mem[109], DATA,  EMP,  EMP, EMP, EMP, EMP, EMP, -11);

  ret= shift_program(mem, 0, 10, 100);

  printf("Program is:\n");
  ret= ret && print_program(mem, 100, 10);
  if (ret != 1)
