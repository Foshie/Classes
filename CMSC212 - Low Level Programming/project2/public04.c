 ...
 *
 * Tests execute_program() with several unary arithmetic and logical
 ...
 * register values that the instructions will operate upon.  The last
 * instruction is "halt", so TERMINATED should be returned.
 */
...
int main() {
  ...
  short exp_registers[NUM_REGISTERS]= {0, 0, 1, -5, 6, 5};
  int num_instructions;
  Status ret;

  num_instructions= assemble("public04.a", mem);
